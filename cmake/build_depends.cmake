IF(RPM)
  ...
  FOREACH (V ${ALL_VARS})
    ...
    ENDIF()
  ENDFOREACH()
  get_property(_extra_rpm_buildrequires GLOBAL PROPERTY RPM_EXTRA_BUILDREQUIRES)
  IF (BUILD_DEPS OR _extra_rpm_buildrequires)
    LIST(APPEND BUILD_DEPS ${_extra_rpm_buildrequires})
