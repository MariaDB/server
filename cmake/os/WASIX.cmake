...
#
# WASIX / WebAssembly target (wasix-libc, Wasmer runtime). Included because
# CMAKE_SYSTEM_NAME is "WASIX" when configured with wasm/wasix-toolchain.cmake.

SET(SYSTEM_TYPE "WASIX")
...
# wasix-libc's <stdio.h> has no P_tmpdir macro; use a literal default.
SET(TMPDIR "/tmp" CACHE PATH "PATH to MySQL TMP dir" FORCE)
...
# wasm-ld provides all symbols statically; no undefined-symbol dance needed.
