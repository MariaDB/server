...
MACRO(BUNDLE_PCRE2)
  ...
  IF(CMAKE_TOOLCHAIN_FILE)
    SET(PCRE2_TOOLCHAIN_ARG "-DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE}")
  ELSE()
    SET(PCRE2_TOOLCHAIN_ARG)
  ENDIF()
...
MACRO (CHECK_PCRE)
  IF (NOT TARGET pcre2 AND NOT PCRE_FOUND)
    IF(WITH_PCRE STREQUAL "system" OR WITH_PCRE STREQUAL "auto")
      ...
      ENDIF()
    ENDIF()
    IF(NOT HAVE_PCRE2_MATCH_8 OR NOT PCRE_INCLUDE_DIRS OR WITH_PCRE STREQUAL "bundled")
