...
MACRO (CHECK_PCRE)
  IF (NOT TARGET pcre2 AND NOT PCRE_FOUND)
    IF(WITH_PCRE STREQUAL "system" OR WITH_PCRE STREQUAL "auto")
      SET(HAVE_PCRE2_MATCH_8 0)
      FIND_PACKAGE(PkgConfig QUIET)
      PKG_CHECK_MODULES(PCRE libpcre2-8)
      IF(NOT "${PCRE_LIBRARY_DIRS}" STREQUAL "")
        SET(PCRE_LINK_LIBRARIES pcre2-8)
        SET(HAVE_PCRE2_MATCH_8 1)
      ELSE()
        # in case pkg-config or libpcre2-8.pc is not installed:
        FIND_LIBRARY(PCRE_LINK_LIBRARIES pcre2-8)
        IF(PCRE_LINK_LIBRARIES)
          MESSAGE(STATUS "PCRE: pkg-config not available or failed, using FIND_LIBRARY fallback: ${PCRE_LINK_LIBRARIES}")
          GET_FILENAME_COMPONENT(PCRE_LIBRARY_DIRS ${PCRE_LINK_LIBRARIES} DIRECTORY)
          SET(HAVE_PCRE2_MATCH_8 1)
        ENDIF()
      ENDIF()
