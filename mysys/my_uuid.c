...
/**
  ...
  UUIDv1 format (RFC 9562 Section 5.1, big-endian):
    ...
    UUIDv1 has "a 60-bit timestamp represented by Coordinated Universal
    Time (UTC) as a count of 100-nanosecond intervals since 00:00:00.00,
    15 October 1582"

  UUIDv7 format (RFC 9562 Section 5.7 Figure 11, big-endian):
    Bytes 0-5:  "48-bit big-endian unsigned number of the Unix Epoch
