...
# elif defined __linux__
  madvise(ptr, size, MADV_DONTNEED); /* Linux mimicing AIX disclaim() */
...
# elif defined MADV_DONTNEED /* an unknown POSIX-like system */
#  warn "It is unclear if madvise(MADV_DONTNEED) works as intended"
  madvise(ptr, size, MADV_DONTNEED);
# else
#  warn "Do not know how to decommit memory"
# endif
