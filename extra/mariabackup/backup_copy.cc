...
void rocksdb_backup_checkpoint(ds_ctxt *ds_data);
void rocksdb_copy_back(ds_ctxt *ds_data);
...
void parse_db_table_from_file_path(const char *filepath, char *dbname,
                                   char *tablename)
{
	dbname[0] = '\0';
	tablename[0] = '\0';
