...
/**
  @defgroup plugin_api_service_my_snprintf My Snprintf service
...
/**
  A portable, limited vsnprintf() implementation, with some extra features.
  ...
  Format extensions:
   ...
   - Format 'sQ'
      ...
      but also "escapes" existing backticks in the string to '\\\`\\\`' as in SQL ''''.
   - Format 'sB'
