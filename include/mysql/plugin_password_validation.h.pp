...
typedef size_t (*PTR_ZSTD_compress_usingCDict)( ZSTD_CCtx *cctx, void *dst, size_t dstCapacity, const void *src, size_t srcSize, const ZSTD_CDict *cdict );
typedef size_t (*PTR_ZSTD_compress_usingDict)( ZSTD_CCtx *ctx, void *dst, size_t dstCapacity, const void *src, size_t srcSize, const void *dict, size_t dictSize, int compressionLevel );
typedef ZSTD_CCtx * (*PTR_ZSTD_createCCtx)();
typedef ZSTD_CCtx * (*PTR_ZSTD_createCCtx_advanced)( ZSTD_customMem customMem );
typedef ZSTD_CDict * (*PTR_ZSTD_createCDict)( const void *dictBuffer, size_t dictSize, int compressionLevel );
typedef ZSTD_DCtx * (*PTR_ZSTD_createDCtx)();
typedef ZSTD_DCtx * (*PTR_ZSTD_createDCtx_advanced)( ZSTD_customMem customMem );
typedef ZSTD_DDict * (*PTR_ZSTD_createDDict_byReference)( const void *dictBuffer, size_t dictSize );
typedef size_t (*PTR_ZSTD_decompress)( void *dst, size_t dstCapacity, const void *src, size_t compressedSize );
typedef size_t (*PTR_ZSTD_decompress_usingDDict)( ZSTD_DCtx *dctx, void *dst, size_t dstCapacity, const void *src, size_t srcSize, const ZSTD_DDict *ddict );
typedef size_t (*PTR_ZSTD_decompress_usingDict)( ZSTD_DCtx *dctx, void *dst, size_t dstCapacity, const void *src, size_t srcSize, const void *dict, size_t dictSize );
typedef size_t (*PTR_ZSTD_freeCCtx)( ZSTD_CCtx *cctx );
typedef size_t (*PTR_ZSTD_freeCDict)( ZSTD_CDict *CDict );
typedef size_t (*PTR_ZSTD_freeDCtx)( ZSTD_DCtx *dctx );
typedef size_t (*PTR_ZSTD_freeDDict)( ZSTD_DDict *ddict );
typedef const char* (*PTR_ZSTD_getErrorName)( size_t code );
typedef unsigned (*PTR_ZSTD_isError)( size_t code );
typedef size_t (*PTR_ZSTD_sizeof_DDict)( const ZSTD_DDict *ddict );
typedef unsigned (*PTR_ZSTD_versionNumber)();
