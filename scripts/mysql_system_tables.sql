...
CREATE TABLE IF NOT EXISTS reverse_db LIKE db;
...
CREATE TABLE IF NOT EXISTS reverse_host LIKE host;
...
CREATE TABLE IF NOT EXISTS reverse_user LIKE user;
...
CREATE TABLE IF NOT EXISTS reverse_tables_priv LIKE tables_priv;
...
CREATE TABLE IF NOT EXISTS reverse_columns_priv LIKE columns_priv;
...
CREATE TABLE IF NOT EXISTS reverse_procs_priv LIKE procs_priv;
