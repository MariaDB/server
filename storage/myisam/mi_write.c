...
static int keys_compare(const void *_param, const void *_key1,
                        const void *_key2)
{
  const bulk_insert_param *param= (const bulk_insert_param *) _param;
  const uchar *key1= (const uchar *) _key1;
  const uchar *key2= (const uchar *) _key2;
  uint not_used[2];
