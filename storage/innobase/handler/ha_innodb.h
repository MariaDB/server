...
protected:
	...
	*/
	...
	Note that the chunk being read is described entirely by
	Parallel_coordinator::Exec_ctx and the progress through it by
	Worker_ctx; neither is copied here, so this state stays valid once
