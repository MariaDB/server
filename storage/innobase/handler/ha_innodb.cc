...
static SHOW_VAR innodb_status_variables[]= {
  ...
  (char*) &ibuf->n_discarded_ops[IBUF_OP_DELETE_MARK], SHOW_LONG},
  {"ibuf_discarded_deletes",
  (char*) &ibuf->n_discarded_ops[IBUF_OP_DELETE],	  SHOW_LONG},
  {"ibuf_discarded_inserts",
  (char*) &ibuf->n_discarded_ops[IBUF_OP_INSERT],	  SHOW_LONG},
  {"ibuf_free_list",
  (char*) &ibuf->free_list_len,		  SHOW_LONG},
  {"ibuf_merged_delete_marks",
  (char*) &ibuf->n_merged_ops[IBUF_OP_DELETE_MARK],	  SHOW_LONG},
  {"ibuf_merged_deletes",
  (char*) &ibuf->n_merged_ops[IBUF_OP_DELETE],	  SHOW_LONG},
  {"ibuf_merged_inserts",
  (char*) &ibuf->n_merged_ops[IBUF_OP_INSERT],	  SHOW_LONG},
  {"ibuf_merges",
  (char*) &ibuf->n_merges,		  SHOW_LONG},
  {"ibuf_segment_size",
  (char*) &ibuf->seg_size,	  SHOW_LONG},
  {"ibuf_size",
  (char*) &ibuf->size,		  SHOW_LONG},
  {"log_waits",
