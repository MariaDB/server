...
static bool
compression_algorithm_is_not_loaded(ulong compression_algorithm) noexcept
{
  do
  {
#ifndef HAVE_LZ4
    if (compression_algorithm == PAGE_LZ4_ALGORITHM) continue;
#endif
#ifndef HAVE_LZO
    if (compression_algorithm == PAGE_LZO_ALGORITHM) continue;
#endif
#ifndef HAVE_LZMA
    if (compression_algorithm == PAGE_LZMA_ALGORITHM) continue;
#endif
#ifndef HAVE_BZIP2
    if (compression_algorithm == PAGE_BZIP2_ALGORITHM) continue;
#endif
#ifndef HAVE_SNAPPY
    if (compression_algorithm == PAGE_SNAPPY_ALGORITHM) continue;
#endif
    return false;
  }
  while (false);
