...
#endif
  {"async_reads_pending",
  &export_vars.innodb_async_io_stats.reads_pending, SHOW_SIZE_T},
  {"async_reads_tasks_running",
  &export_vars.innodb_async_io_stats.reads_tasks_running, SHOW_SIZE_T},
  {"async_reads_queue_size",
  &export_vars.innodb_async_io_stats.reads_queue_size, SHOW_SIZE_T},
  {"async_writes_pending",
  &export_vars.innodb_async_io_stats.writes_pending, SHOW_SIZE_T},
  {"async_writes_tasks_running",
  &export_vars.innodb_async_io_stats.writes_tasks_running, SHOW_SIZE_T},
  {"async_writes_queue_size",
  &export_vars.innodb_async_io_stats.writes_queue_size, SHOW_SIZE_T},
