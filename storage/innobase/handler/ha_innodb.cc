...
static SHOW_VAR innodb_status_variables[]= {
  ...
  {"s_lock_os_waits",
  (char*) &rw_lock_stats.rw_s_os_wait_count,		  SHOW_LONGLONG},
  {"s_lock_spin_rounds",
  (char*) &rw_lock_stats.rw_s_spin_round_count,	  SHOW_LONGLONG},
  {"s_lock_spin_waits",
  (char*) &rw_lock_stats.rw_s_spin_wait_count,	  SHOW_LONGLONG},
  {"truncated_status_writes",
  (char*) &export_vars.innodb_truncated_status_writes,	  SHOW_LONG},
  {"x_lock_os_waits",
  (char*) &rw_lock_stats.rw_x_os_wait_count,		  SHOW_LONGLONG},
  {"x_lock_spin_rounds",
  (char*) &rw_lock_stats.rw_x_spin_round_count,	  SHOW_LONGLONG},
  {"x_lock_spin_waits",
  (char*) &rw_lock_stats.rw_x_spin_wait_count,	  SHOW_LONGLONG},
