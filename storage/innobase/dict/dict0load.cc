...
err_exit:
	...
	takes load_latch in exclusive mode on our behalf before the stub
                                     ...
                                     dict_err_ignore_t ignore) noexcept
{
  ...
  load_latch. They will block on the exclusive dict_sys.latch until
