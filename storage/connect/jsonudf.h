...
#define UDF_EXEC_ARGS \
  UDF_INIT*, UDF_ARGS*, char*, unsigned long*, unsigned char*, unsigned char*
...
extern "C" {
	...
	DllExport long long jsonsum_int(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
	DllExport void jsonsum_int_deinit(UDF_INIT*);

	DllExport my_bool jsonsum_real_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport double jsonsum_real(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
	DllExport void jsonsum_real_deinit(UDF_INIT*);

	DllExport my_bool jsonavg_real_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport double jsonavg_real(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
	...
	DllExport long long jsonset_grp_size(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);

	DllExport my_bool jsonget_grp_size_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport long long jsonget_grp_size(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);

	DllExport my_bool json_array_grp_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport void json_array_grp_add(UDF_INIT *, UDF_ARGS *, unsigned char *, unsigned char *);
	DllExport char *json_array_grp(UDF_EXEC_ARGS);
	DllExport void json_array_grp_clear(UDF_INIT *, unsigned char *, unsigned char *);
	DllExport void json_array_grp_deinit(UDF_INIT*);

	DllExport my_bool json_object_grp_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport void json_object_grp_add(UDF_INIT *, UDF_ARGS *, unsigned char *, unsigned char *);
	DllExport char *json_object_grp(UDF_EXEC_ARGS);
	DllExport void json_object_grp_clear(UDF_INIT *, unsigned char *, unsigned char *);
	...
	DllExport long long jsonget_int(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
	DllExport void jsonget_int_deinit(UDF_INIT*);

	DllExport my_bool jsonget_real_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport double jsonget_real(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
	DllExport void jsonget_real_deinit(UDF_INIT*);

	DllExport my_bool jsoncontains_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport long long jsoncontains(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
	...
	DllExport long long jsoncontains_path(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
	...
	DllExport long long countin(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
} // extern "C"																											  
