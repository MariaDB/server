...
extern "C" {
	...
	DllExport long long bson_contains(UDF_INIT*, UDF_ARGS*, unsigned char *, unsigned char *);
	DllExport void bson_contains_deinit(UDF_INIT*);

	DllExport my_bool bsoncontains_path_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport long long bsoncontains_path(UDF_INIT*, UDF_ARGS*, unsigned char *, unsigned char *);
	...
	DllExport long long bsonget_int(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
	DllExport void bsonget_int_deinit(UDF_INIT*);

	DllExport my_bool bsonget_real_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport double bsonget_real(UDF_INIT*, UDF_ARGS*, unsigned char*, unsigned char*);
	DllExport void bsonget_real_deinit(UDF_INIT*);

	DllExport my_bool bsonset_def_prec_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport long long bsonset_def_prec(UDF_INIT*, UDF_ARGS*, unsigned char *, unsigned char *);

	DllExport my_bool bsonget_def_prec_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport long long bsonget_def_prec(UDF_INIT*, UDF_ARGS*, unsigned char *, unsigned char *);

	DllExport my_bool bsonset_grp_size_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport long long bsonset_grp_size(UDF_INIT*, UDF_ARGS*, unsigned char *, unsigned char *);

	DllExport my_bool bsonget_grp_size_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport long long bsonget_grp_size(UDF_INIT*, UDF_ARGS*, unsigned char *, unsigned char *);

	DllExport my_bool bson_array_grp_init(UDF_INIT*, UDF_ARGS*, char*);
	DllExport void bson_array_grp_clear(UDF_INIT *, unsigned char *, unsigned char *);
	DllExport void bson_array_grp_add(UDF_INIT *, UDF_ARGS *, unsigned char *, unsigned char *);
	...
	DllExport void bson_object_grp_clear(UDF_INIT *, unsigned char *, unsigned char *);
	DllExport void bson_object_grp_add(UDF_INIT *, UDF_ARGS *, unsigned char *, unsigned char *);
	...
	DllExport void bbin_array_grp_clear(UDF_INIT *, unsigned char *, unsigned char *);
	DllExport void bbin_array_grp_add(UDF_INIT *, UDF_ARGS *, unsigned char *, unsigned char *);
	...
	DllExport void bbin_object_grp_clear(UDF_INIT *, unsigned char *, unsigned char *);
	DllExport void bbin_object_grp_add(UDF_INIT *, UDF_ARGS *, unsigned char *, unsigned char *);
