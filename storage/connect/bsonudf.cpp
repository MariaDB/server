...
char* bsonvalue(UDF_INIT* initid, UDF_ARGS* args, char* result,
	unsigned long* res_length, unsigned char*, unsigned char*)
{
	char   *str;
...
char* bson_array_add_values(UDF_INIT* initid, UDF_ARGS* args, char* result,
	unsigned long* res_length, unsigned char* is_null, unsigned char*) {
	char* str = NULL;
	PGLOBAL g = (PGLOBAL)initid->ptr;
...
char *bson_array_add(UDF_INIT *initid, UDF_ARGS *args, char *result, 
	unsigned long *res_length, unsigned char *is_null, unsigned char *error)
{
	char   *str = NULL;
	PGLOBAL g = (PGLOBAL)initid->ptr;
...
long long bsonset_def_prec(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *)
{
...
long long bsonget_def_prec(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *)
{
	return (long long)GetJsonDefPrec();
...
long long bsonset_grp_size(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *)
{
	long long n = *(long long*)args->args[0];
...
long long bsonget_grp_size(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *)
{
	return (long long)GetJsonGroupSize();
...
void bson_array_grp_clear(UDF_INIT *initid, unsigned char*, unsigned char*)
{
	PGLOBAL g = (PGLOBAL)initid->ptr;
...
void bson_array_grp_add(UDF_INIT *initid, UDF_ARGS *args, unsigned char*, unsigned char*)
{
	PGLOBAL g = (PGLOBAL)initid->ptr;
	PBJNX   bxp = (PBJNX)((char*)g->Sarea + sizeof(POOLHEADER));
...
void bson_object_grp_clear(UDF_INIT *initid, unsigned char*, unsigned char*)
{
	PGLOBAL g = (PGLOBAL)initid->ptr;
	PBJNX   bxp = (PBJNX)((char*)g->Sarea + sizeof(POOLHEADER));
...
void bson_object_grp_add(UDF_INIT *initid, UDF_ARGS *args, unsigned char*, unsigned char*)
{
	PGLOBAL g = (PGLOBAL)initid->ptr;
	PBJNX   bxp = (PBJNX)((char*)g->Sarea + sizeof(POOLHEADER));
...
long long bson_contains(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *error)
{
	unsigned char isn;
	char          res[256];
...
long long bsoncontains_path(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *error)
{
	char   *p, *path;
	long long n;
	PBVAL   jsp;
...
char *bson_set_item(UDF_INIT *initid, UDF_ARGS *args, char *result,
	unsigned long *res_length, unsigned char *is_null, unsigned char *p)
{
	strcpy(result, "$set");
...
char *bfile_bjson(UDF_INIT *initid, UDF_ARGS *args, char *result,
	unsigned long *res_length, unsigned char*, unsigned char *error) {
...
void bbin_array_grp_clear(UDF_INIT *initid, unsigned char *a, unsigned char *b)
{
	bson_array_grp_clear(initid, a, b);
} // end of bbin_array_grp_clear

void bbin_array_grp_add(UDF_INIT *initid, UDF_ARGS *args, unsigned char *a, unsigned char *b)
{
...
void bbin_object_grp_clear(UDF_INIT *initid, unsigned char *a, unsigned char *b)
{
	bson_object_grp_clear(initid, a, b);
} // end of bbin_object_grp_clear

void bbin_object_grp_add(UDF_INIT *initid, UDF_ARGS *args, unsigned char *a, unsigned char *b)
{
