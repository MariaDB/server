...
long long jsonsum_int(UDF_INIT *initid, UDF_ARGS *args, unsigned char *is_null, unsigned char *error)
{
	long long n = 0LL;
	PGLOBAL g = (PGLOBAL)initid->ptr;
...
double jsonsum_real(UDF_INIT *initid, UDF_ARGS *args, unsigned char *is_null, unsigned char *error)
{
	double  n = 0.0;
	PGLOBAL g = (PGLOBAL)initid->ptr;
...
double jsonavg_real(UDF_INIT *initid, UDF_ARGS *args, unsigned char *is_null, unsigned char *error)
{
	double  n = 0.0;
	PGLOBAL g = (PGLOBAL)initid->ptr;
...
char *json_object_add(UDF_INIT *initid, UDF_ARGS *args, char *result,
                          unsigned long *res_length, unsigned char *is_null,
                          unsigned char *error)
{
	PCSZ    key;
	char   *str = NULL;
...
long long jsonset_grp_size(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *)
{
...
long long jsonget_grp_size(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *)
{
	return (long long)GetJsonGroupSize();
...
void json_array_grp_add(UDF_INIT *initid, UDF_ARGS *args, unsigned char*, unsigned char*)
{
  PGLOBAL g = (PGLOBAL)initid->ptr;
...
void json_array_grp_clear(UDF_INIT *initid, unsigned char*, unsigned char*)
{
  PGLOBAL g = (PGLOBAL)initid->ptr;
...
void json_object_grp_add(UDF_INIT *initid, UDF_ARGS *args, unsigned char*, unsigned char*)
{
  PGLOBAL g = (PGLOBAL)initid->ptr;
...
void json_object_grp_clear(UDF_INIT *initid, unsigned char*, unsigned char*)
{
  PGLOBAL g = (PGLOBAL)initid->ptr;
...
long long jsoncontains(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *error)
{
	unsigned char isn;
	char          res[256];
...
long long jsoncontains_path(UDF_INIT *initid, UDF_ARGS *args, unsigned char *, unsigned char *error)
{
	char   *p, *path;
	long long n;
	PJSON   jsp;
...
long long countin(UDF_INIT *initid, UDF_ARGS *args, unsigned char *is_null, unsigned char *)
{
	PSZ str1, str2;
	char *s;
	long long n = 0;
