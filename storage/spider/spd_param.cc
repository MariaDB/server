...
SPIDER_SYSVAR_VALUE_FUN(uint, udf_table_lock_mutex_count)
...
SPIDER_SYSVAR_VALUE_FUN(uint, udf_table_mon_mutex_count)
...
SPIDER_THDVAR_OVERRIDE_VALUE_FUN(longlong, udf_ds_bulk_insert_rows)
...
SPIDER_THDVAR_OVERRIDE_VALUE_FUN(int, udf_ds_table_loop_mode)
...
SPIDER_THDVAR_OVERRIDE_VALUE_FUN(int, use_handler)
...
SPIDER_THDVAR_OVERRIDE_VALUE_FUN(int, udf_ds_use_real_table)
#endif
