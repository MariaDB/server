...
public:
  ...
  int append_table_list(ha_spider *spider, spider_fields *fields,
                        spider_string *str, TABLE_LIST *table,
                        table_map *upper_usable_tables,
                        table_map eliminated_tables);
  int append_table_array(ha_spider *spider, spider_fields *fields,
                         spider_string *str, TABLE_LIST **table,
                         TABLE_LIST **end, table_map *upper_usable_tables,
                         table_map eliminated_tables);
  int append_join(ha_spider *spider, spider_fields *fields, spider_string *str,
