                                            ...
                                            table_map eliminated_tables)
{
  ...
  /* FIXME: assuming normal table for now. In TABLE_LIST::print there
  are also view, derived and table function considerations. */
                                      ...
                                      table_map eliminated_tables)
{
  ...
  /* FIXME: print_join() also checks for TABLE_LIST::optimized_away. */
