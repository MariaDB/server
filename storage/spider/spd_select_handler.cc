                                       ...
                                       ha_spider *spider)
{
  ...
  /*
    Prepare various "setup queries" according to various spider system
    variables.

    In gbh this is part of spider_internal_start_trx_for_connection
    called from dml_init().
  */
                                             ...
                                             SELECT_LEX_UNIT *)
{
  ...
  */
  if (spider_param_disable_select_handler(thd))
    return NULL;
  /*
    Do not support UPDATE/DELETE. TODO: how about subqueries in
    UPDATE/DELETE?
  */
