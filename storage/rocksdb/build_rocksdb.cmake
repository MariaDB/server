...
macro(check_lib package)
  ...
  IF(${${package}_VALID})
    ...
    set(_rocksdb_package_include_dirs)
    if(DEFINED ${var}_INCLUDE_DIRS AND NOT "${${var}_INCLUDE_DIRS}" STREQUAL "")
      list(APPEND _rocksdb_package_include_dirs ${${var}_INCLUDE_DIRS})
    endif()
    if(DEFINED ${var}_INCLUDE_DIR AND NOT "${${var}_INCLUDE_DIR}" STREQUAL "")
      list(APPEND _rocksdb_package_include_dirs ${${var}_INCLUDE_DIR})
    endif()
    if(_rocksdb_package_include_dirs)
      include_directories(${_rocksdb_package_include_dirs})
    endif()
