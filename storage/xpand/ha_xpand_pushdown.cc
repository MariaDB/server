...
create_xpand_select_handler(THD* thd, SELECT_LEX* select_lex)
{
  ...
  uchar *meta_memory= (uchar *)my_multi_malloc(PSI_NOT_INSTRUMENTED, MYF(MY_WME),
                                               &fieldtype, items_number,
                                               &null_bits, num_null_bytes,
                                               &field_metadata, (items_number * 2),
                                               NULL);
...
int ha_xpand_derived_handler::init_scan()
{
  ...
  uchar *null_bits = NULL;
  uchar *field_metadata = NULL;
  uchar *meta_memory= (uchar *)my_multi_malloc(PSI_INSTRUMENT_ME, MYF(MY_WME),
                                               &fieldtype, items_number,
                                               &null_bits, num_null_bytes,
                                               &field_metadata, (items_number * 2),
                                               NULL);
