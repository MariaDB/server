...
# define os_aio(type, mode, name, file, buf, offset,			\
    ...
    trx, page_compressed, page_compression_level, write_size, page_encryption, page_encryption_key)	\
	pfs_os_aio_func(type, mode, name, file, buf, offset,		\
		n, message1, message2, space_id, trx,			\
        page_compressed, page_compression_level, write_size, page_encryption, page_encryption_key,	\
		__FILE__, __LINE__)
