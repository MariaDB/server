  ...
  m_last_activity()
{
  ...
  /**
    start the maintainence timer, unless pool is fixed size
    (then, no maintainence is required).
  */
  if (min_threads != max_threads)
  {
    m_maintenance_timer= new timer_generic(
        thread_pool_generic::maintenance_func, this, nullptr);
