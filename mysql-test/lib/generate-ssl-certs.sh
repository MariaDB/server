...
export OPENSSL_CONF="$PWD/lib/openssl.cnf"
...
openssl ca -keyfile cakey.pem -days 7300 -batch -cert cacert.pem -policy policy_anything -outdir . -out server-cert.pem -in demoCA/server-req.pem
...
openssl ca -keyfile cakey.pem -days 7301 -batch -cert cacert.pem -policy policy_anything -outdir . -out server-new-cert.pem -in demoCA/server-new-req.pem
...
openssl ca -keyfile cakey.pem -days 7300 -batch -cert cacert.pem -policy policy_anything -outdir .  -out server8k-cert.pem -in demoCA/server8k-req.pem
...
openssl ca -keyfile cakey.pem -extfile demoCA/sanext.conf -days 7300 -batch -cert cacert.pem -policy policy_anything -outdir . -out serversan-cert.pem -in demoCA/serversan-req.pem
...
openssl ca -keyfile cakey.pem -days 7300 -batch -cert cacert.pem -policy policy_anything -outdir . -out client-cert.pem -in demoCA/client-req.pem
...
openssl ca -gencrl -keyfile cakey.pem -crldays 7300 -batch -cert cacert.pem -outdir . -out server-cert.crl
...
openssl ca -gencrl -keyfile cakey.pem -crldays 7300 -batch -cert cacert.pem -outdir . -out client-cert.crl
