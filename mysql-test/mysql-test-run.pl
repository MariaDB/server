...
my $rebootstrap_re= '--innodb[-_](?:page[-_]size|checksum[-_]algorithm|buffer[-_]pool[-_]filename|undo[-_]tablespaces|log[-_]group[-_]home[-_]dir|data[-_]home[-_]dir)|data[-_]file[-_]path|force_rebootstrap';
