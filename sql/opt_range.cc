...
static void trace_ranges(
    Json_writer_array *range_trace, PARAM *param, uint idx, SEL_ARG *keypart,
    const KEY_PART_INFO *key_parts, size_t found_records= 0,
    void (*record_ranges_for_tbl_fn)(THD *, TABLE_LIST *, size_t, const char *,
                                     List<char> *)= NULL);
              ...
              !thd->lex->explain->is_query_plan_ready())
          {
            ...
            */
            trace_ranges(&trace_range, param, idx, key, key_part,
                         found_records, &record_ranges_for_tbl);
                                     ...
                                     List<char> *))
{
  ...
  */
  ...
  List<char> *range_list= NULL;
  if (record_ranges_for_tbl_fn)
  {
  ...
  if (range_list)
    record_ranges_for_tbl_fn(param->thd, param->table->pos_in_table_list,
                             found_records,
