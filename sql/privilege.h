...
public:
  ...
  */
  ...
  /*
    ...
    while this one is hierarchical, use from going from global to db etc until
...
inline access_t merge_same_level(const access_t &first, const access_t &second, const access_t& third)
{
