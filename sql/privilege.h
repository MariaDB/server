...
constexpr privilege_t PRIV_SET_SYSTEM_GLOBAL_VAR_MAX_PASSWORD_ERRORS=
  CONNECTION_ADMIN_ACL;
// Was SUPER_ACL prior to 10.5.2
constexpr privilege_t PRIV_SET_SYSTEM_GLOBAL_VAR_PASSWORD_ERRORS_BEFORE_DELAY=
    CONNECTION_ADMIN_ACL;
constexpr privilege_t PRIV_SET_SYSTEM_GLOBAL_VAR_MAX_NONEXISTENT_USER_STORE_SIZE=
    CONNECTION_ADMIN_ACL;
// Was SUPER_ACL prior to 10.5.2
