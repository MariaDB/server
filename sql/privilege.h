...
constexpr privilege_t PRIV_SET_SYSTEM_GLOBAL_VAR_BINLOG_DUMP_DO_DB =
  BINLOG_ADMIN_ACL | SUPER_ACL;

constexpr privilege_t PRIV_SET_SYSTEM_GLOBAL_VAR_BINLOG_DUMP_IGNORE_DB =
  BINLOG_ADMIN_ACL | SUPER_ACL;

constexpr privilege_t PRIV_SET_SYSTEM_GLOBAL_VAR_BINLOG_DUMP_DO_TABLE =
  BINLOG_ADMIN_ACL | SUPER_ACL;

constexpr privilege_t PRIV_SET_SYSTEM_GLOBAL_VAR_BINLOG_DUMP_IGNORE_TABLE =
  BINLOG_ADMIN_ACL | SUPER_ACL;

constexpr privilege_t PRIV_SET_SYSTEM_GLOBAL_VAR_BINLOG_DUMP_WILD_DO_TABLE =
  BINLOG_ADMIN_ACL | SUPER_ACL;

constexpr privilege_t PRIV_SET_SYSTEM_GLOBAL_VAR_BINLOG_DUMP_WILD_IGNORE_TABLE =
  BINLOG_ADMIN_ACL | SUPER_ACL;
