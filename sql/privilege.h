...
/*
  A combination of all privileges that SUPER used to allow up to 10.10
*/
constexpr privilege_t ALLOWED_BY_SUPER_UPTO_1010= READ_ONLY_ADMIN_ACL;

/*
  A combination of all privileges that SUPER used to allow up to 10.11
*/
constexpr privilege_t ALLOWED_BY_SUPER_UPTO_1011=
  SET_USER_ACL |
  FEDERATED_ADMIN_ACL |
...
constexpr privilege_t GLOBAL_ACLS=
  ...
  REPL_SLAVE_ACL | ALLOWED_BY_SUPER_UPTO_1010 | ALLOWED_BY_SUPER_UPTO_1011;
