  ...
  */
       ...
       !is_binlog_read_write(thd)))
  {
    /*
      ...
      or such transaction xa-prepare.
      While the normal transaction commit sinks in here unconditionally,
      the binlog-cache empty xa-prepare and xa-commit do so under
