...
function_call_generic:
          ident_cli_func '('
          {
            ...
            aggregate= native_builder && native_builder->is_aggregate();
#ifdef HAVE_DLOPEN
            ...
            $<generic_function>$.builder= native_builder;
            $<generic_function>$.udf= udf;
            $<generic_function>$.aggregate= aggregate;
          }

          opt_distinct opt_udf_expr_list_or_join_operator ')'
          opt_object_member_access opt_filter_expr
          {
            const Type_handler *h;
            Create_func *builder= $<generic_function>3.builder;
            Item *item= NULL;
            ...
            */
            ...
            Item_sum *sum_item= (item &&
                                 item->type() == Item::SUM_FUNC_ITEM) ?
                                static_cast<Item_sum *>(item) : NULL;
            if ($4)
            {
