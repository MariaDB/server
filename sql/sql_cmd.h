...
enum enum_sql_command {
  ...
  SQLCOM_SHOW_COLLATIONS, SQLCOM_SHOW_TRIGGERS,
  SQLCOM_SHOW_CREATE_CATALOG, SQLCOM_SHOW_CREATE_DB, SQLCOM_SHOW_TABLE_STATUS,

  SQLCOM_LOAD,SQLCOM_SET_OPTION,SQLCOM_LOCK_TABLES,SQLCOM_UNLOCK_TABLES,
  SQLCOM_GRANT,
  SQLCOM_CHANGE_CATALOG, SQLCOM_CHANGE_DB,
  SQLCOM_CREATE_DB, SQLCOM_DROP_DB, SQLCOM_ALTER_DB,
  ...
  SQLCOM_CREATE_CATALOG, SQLCOM_DROP_CATALOG, SQLCOM_ALTER_CATALOG,
