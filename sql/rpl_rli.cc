...
Relay_log_info::Relay_log_info(bool is_slave_recovery, const char* thread_name)
  :Slave_reporting_capability(thread_name),
   ...
   group_relay_log_pos(0), event_relay_log_pos(0), group_master_log_pos(0),
   log_space_total(0), ignore_log_space_limit(0), last_master_timestamp(0),
   sql_thread_caught_up(true), worker_threads_caught_up(true),
   slave_skip_counter(0), abort_pos_wait(0), slave_run_id(0), sql_driver_thd(),
