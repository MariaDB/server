                                    ...
                                    uint *key_count, int create_table_mode)
{
  ...
  */
  ...
  if (identity_column && !found_identity_key)
  {
    ...
    Key *new_key= new(thd->mem_root) Key(Key::MULTIPLE, &null_clex_str,
                                         HA_KEY_ALG_BTREE, true, {});
    Key_part_spec *kp= new(thd->mem_root) Key_part_spec(
                                               &identity_column->field_name, 0);
