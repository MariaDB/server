                      ...
                      size_t query_length, bool is_trans)
{
  ...
  {
    /*
      Mark that we have accepted the new table and do not need to revert it
      in case of crashes. With atomic_replace it also ensures that the
      ddl_log_state_rm will run, as it would be if binary logging would be
      used
    */
  ...
  /*
    ...
    table would be deleted. ddl_log_state_create will not be used.
  */
...
bool Table_specification_st::
finalize_locked_tables(THD *thd, bool operation_failed)
{
  ...
  if (or_replace())
  {
    ...
    */
    ...
    {
      /*
        Table was closed as part of renaming it to a temporary table.
