...
/**
  Check if AUTO_INCREMENT was set as requested and issue a note if not.

  MDEV-33660: When ALTER TABLE ... AUTO_INCREMENT=N is used with N lower
  than the next AUTO_INCREMENT value, the engine keeps the higher value.
  This function checks and issues a note if so.

  @param thd           Thread handle
  @param create_info   Create info with requested auto_increment value
  @param table         Table to check (must be open with a valid handler)
*/
