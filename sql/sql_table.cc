                                      ...
                                      Alter_info *alter_info)
{
  ...
  key->columns.push_back(new (thd->mem_root)
                             Key_part_spec(&fld->field_name, 0, true),
                         thd->mem_root);
                          ...
                          Alter_table_ctx *alter_ctx)
{
  ...
  */
  ...
  /*
    ...
    and the field is an autogenerated pk field, mark the generated_pk_field
    to be dropped later.
  */
  ...
  for (f_ptr=table->field ; (field= *f_ptr) ; f_ptr++)
  {
    if (field->invisible == INVISIBLE_FULL)
    {
      /*
        ...
        the new table.
      */
      if (user_added_pk && generated_pk_field == field)
      {
        continue;
      }
