...
extern "C" const uchar *sp_table_key(const uchar *ptr, size_t *plen,
                                     my_bool first);
...
const uchar *sp_table_key(const uchar *ptr, size_t *plen, my_bool first)
{
  SP_TABLE *tab= (SP_TABLE *)ptr;
  *plen= tab->qname.length;
  return static_cast<const uchar *>(static_cast<const void *>(tab->qname.str));
}
