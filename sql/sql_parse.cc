...
add_proc_to_list(THD* thd, Item *item)
{
  ...
  thd->lex->proc_list.link_in_list(&order_item->order, &order_item->order.next);
  return 0;
}
...
Item *normalize_cond(THD *thd, Item *cond)
{
  if (cond)
  {
    ...
    if (type == Item::FIELD_ITEM || type == Item::REF_ITEM)
    {
      ...
      cond= new (thd) Item_func_ne(thd, cond, new (thd) Item_int(thd, 0));
      if (cond)
      ...
      if (type == Item::FUNC_ITEM)
      {
        ...
        if (func_item->functype() == Item_func::NOT_FUNC)
        {
          ...
          if (arg->type() == Item::FIELD_ITEM ||
            ...
            cond= new (thd) Item_func_eq(thd, arg,
                                          new (thd) Item_int(thd, 0));
        }
      }
    }
  }
...
Item *negate_expression(THD *thd, Item *expr)
{
      ...
      ((Item_func *) expr)->functype() == Item_func::NOT_FUNC)
  {
    ...
    */
    return new (thd) Item_func_ne(thd, arg,
                                  new (thd) Item_int(thd, (char*) "0", 0, 1));
  }
