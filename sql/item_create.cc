...
class Create_func_xact_status : public Create_native_func
{
public:
  Item *create_native(THD *thd, const LEX_CSTRING *name,
                              List<Item> *item_list) override;

  static Create_func_xact_status s_singleton;

protected:
  Create_func_xact_status() = default;
  ~Create_func_xact_status() override = default;
};
...
Create_func_xact_status Create_func_xact_status::s_singleton;

Item*
Create_func_xact_status::create_native(THD *thd, const LEX_CSTRING *name,
                                       List<Item> *item_list)
{
  Item *func= NULL;
  int arg_count= 0;
  ...
  case 2:
  {
    func= new (thd->mem_root) Item_xact_status(thd, param_1, param_2);
    break;
  }
  case 3:
  {
    Item *param_3= item_list->pop();
    func= new (thd->mem_root) Item_xact_status(thd, param_1, param_2, param_3);
    break;
  }
  }
...
#endif /* WITH_WSREP */
  { { STRING_WITH_LEN("XACT_STATUS") }, BUILDER(Create_func_xact_status)},
