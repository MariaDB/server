...
#define MY_MALLOC(arg) my_malloc(PSI_INSTRUMENT_ME, arg, MYF(0))
#define MY_REALLOC(p, arg) my_realloc(PSI_INSTRUMENT_ME, p, arg, MYF(MY_ALLOW_ZERO_PTR))
#define MY_STRDUP(arg) my_strdup(PSI_INSTRUMENT_ME, arg, MYF(0))
