...
{
  sp_instr_set_composite_field_by_name(
    const sp_instr_set_composite_field_by_name &);
  void operator=(sp_instr_set_composite_field_by_name &);
...
class sp_instr_set_composite_field_by_key : public sp_instr_set
{
  sp_instr_set_composite_field_by_key(
    const sp_instr_set_composite_field_by_key &);
  void operator=(sp_instr_set_composite_field_by_key &);
