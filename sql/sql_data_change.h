...
*/
class Copy_info_statistics {
  public:
    Copy_info_statistics()
      : records(0), deleted(0), updated(0),
        copied(0), error_count(0), touched(0) {}
...
class COPY_INFO : public Copy_info_statistics
{
public:
...
public:
  ...
  */
  ...
  /**
     ...
     @param ignore_errors  The policy for errors
...
@endverbatim
  ...
  */
  COPY_INFO(operation_type optype, List<Item> *inserted_columns,
            ...
            bool ignore_duplicates, int escape_character)
      : Copy_info_statistics(),
        m_optype(optype),
        m_changed_columns(inserted_columns),
