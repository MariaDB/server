...
SHOW_VAR status_vars[]= {
  ...
  {"Feature_sql_mode_oracle",  (char*) offsetof(STATUS_VAR, feature_sqlmode_oracle), SHOW_LONG_STATUS},
  ...
  {"Feature_unique_hash_index", (char*) offsetof(STATUS_VAR, feature_long_hash_index), SHOW_LONG_STATUS},
