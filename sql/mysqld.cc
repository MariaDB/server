...
char *opt_ssl_ca= NULL, *opt_ssl_capath= NULL, *opt_ssl_cert= NULL,
  ...
  *opt_ssl_crlpath= NULL, *opt_tls_version= NULL, *opt_ssl_passphrase_command= NULL;
...
*/
  ...
  if (opt_use_ssl)
  {
    ...
    ssl_acceptor_fd= new_VioSSLAcceptorFd(opt_ssl_key, opt_ssl_cert,
					  ...
					  tls_version, opt_ssl_passphrase_command);
...
int reinit_ssl()
{
  ...
  st_VioSSLFd *new_fd = new_VioSSLAcceptorFd(opt_ssl_key, opt_ssl_cert,
    ...
    opt_ssl_crlpath, tls_version, opt_ssl_passphrase_command);
