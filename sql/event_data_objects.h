...
public:
  ...
  /**
    This flag indicates whether the loaded object represents a record
    containing trigger or event metadata. True in case the loaded record of
    the table mysq.event represents trigger, false for the real event.
  */
