...
public:
  ...
  */
  ...
  /**
    ...
    - thd->security_ctx pointer itself, not the fields it points to
      (see set_security_context() -- MDEV-39146)
  ...
  */
  ...
  /*
    ...
    under the same mutex, or a reader can catch a Security_context whose
    backing storage (e.g. a stack-allocated DEFINER switch) already went
    away (MDEV-39146).
  */
