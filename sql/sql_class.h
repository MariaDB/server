...
public:
  ...
  */
  ...
  /*
    ...
    So far only Item_param, Item_func, Item_sp_variable can have side effects.
    For other Item types this flag is not collected, hence the name.
  */
...
public:
  ...
  */
  ...
  void expr_event_handler_all(THD *thd, expr_event_t event);
...
public:
  ...
  /*
    Free all data type side effects (e.g. SYS_REFCURSORs)
    It's called in the very end of the top level statement
    (it's not called for individual stored routune statements).
  */
