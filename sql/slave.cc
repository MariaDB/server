                                       ...
                                       String *gtid_pos)
{
  ...
  if (mi->host[0])
  {
    ...
    */
    ...
    prot_store_ids<Protocol, bool>(thd, &mi->ignore_server_ids, thd->protocol, &Protocol::store);
    // Master_Server_id
    ...
    mi->domain_id_filter.store_ids<Protocol, bool>(thd, thd->protocol, &Protocol::store);
