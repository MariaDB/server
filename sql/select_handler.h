...
/**
  ...
  The whole statement being the unit of the pushdown, the handler is built
  from the LEX of the statement rather than from a single SELECT_LEX.
*/

class multi_upddel_handler : public pushdown_handler
{
public:
  multi_upddel_handler(THD *thd_arg, handlerton *ht_arg, LEX *lex_arg);
