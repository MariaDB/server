...
int get_or_create_user_login_failed_record(
    THD *thd, st_user_login_failed_record **result);
int get_user_login_failed_record(THD *thd,
                                 st_user_login_failed_record **result);
