  ...
  */
  if (!table->s->tmp_table)
  {
        ...
        table->file->ht->db_type == DB_TYPE_INNODB)
    {
      ...
      */
      int rcode= wsrep_append_table_keys(thd, create_table->table_name.str,
                                         create_table->db.str, table_list,
                                         WSREP_SERVICE_KEY_EXCLUSIVE);
      rcode= rcode || wsrep_append_table_keys(thd, nullptr, nullptr,
                                              select_tables,
