                              ...
                              List<FVectorRef> *neighbours)
{
  ...
  pq.init(10000, 0, 0, cmp_vec, &target);
  pq_discard.init(10000, 0, 0, cmp_vec, &target);
  best.init(max_neighbour_connections, 0, true, cmp_vec, &target);
                         ...
                         List<FVectorRef> *result)
{
  ...
  candidates.init(10000, 0, false, cmp_vec, &target);
  best.init(max_candidates_return, 0, true, cmp_vec, &target);
