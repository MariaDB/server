...
extern Atomic_counter<unsigned long> delayed_insert_threads, delayed_insert_errors;
extern Atomic_counter<unsigned long> delayed_insert_writes, delayed_rows_in_use;
