...
enum options_mysqld
{
  ...
  OPT_BINLOG_DUMP_DO_DB,
  OPT_BINLOG_DUMP_IGNORE_DB,
  OPT_BINLOG_DUMP_DO_TABLE,
  OPT_BINLOG_DUMP_WILD_DO_TABLE,
  OPT_BINLOG_DUMP_IGNORE_TABLE,
  OPT_BINLOG_DUMP_WILD_IGNORE_TABLE,
  OPT_BIN_LOG,
  OPT_BOOTSTRAP,
