...
enum enum_mariadb_xact_status {
  MARIADB_XACT_COMMITTED,    // Transaction ID found in binlog
  MARIADB_XACT_ABORTED,      // Transaction ID not found after start GTID
  MARIADB_XACT_IN_PROGRESS,  // Not used currently
  MARIADB_XACT_UNKNOWN,      // Neither transaction ID nor start GTID found
};
...
int xact_search(uint64 xact_connect_id, uint64 xact_commit_id,
