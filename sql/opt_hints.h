...
/*
  ...
  Non-index hints may be fixed before TABLE instances are available, using a
  TABLE_LIST instance.
...
public:
  ...
  /**
    ...
    the TABLE_LIST argument and links both *this and the
    Opt_hints_table object to that TABLE_LIST instance,
    fixing the hint for use by the application code.
