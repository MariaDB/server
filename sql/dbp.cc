...
static void dbug_add_print_item_contents(Item *item)
{
  ...
  if (item->type() == Item::REF_ITEM)
  {
    ...
    if (ref)
    {
      ...
      {
        DBUG_SPRINTF_CAT("(Item_ref*)(name:'%s.%s',",
          ((Item_ref*)item)->table_name.str, item->name);
      }
      else
        DBUG_SPRINTF_CAT("(Item_ref*)(name:'%s',", item->name);
...
static void dbug_add_print_item(Item *item)
{
  if (item)
  {
    ...
    case Item::FUNC_ITEM:
      {
        ...
        case Item_func::EQ_FUNC: DBUG_CAT("(Item_func_eq*)"); break;
        case Item_func::LIKE_FUNC: DBUG_CAT("(Item_func_like*)"); break;
        case Item_func::EQUAL_FUNC: DBUG_CAT("(Item_func_equal*)"); break;
        case Item_func::ISNULL_FUNC: DBUG_CAT("(Item_func_isnull*)"); break;
        case Item_func::UNKNOWN_FUNC:
          if (func_item->func_name())
            ...
            DBUG_CAT("(Item_func*)");
          break;
        case Item_func::NE_FUNC: DBUG_CAT("(Item_func_ne*)"); break;
        case Item_func::LT_FUNC: DBUG_CAT("(Item_func_lt*)"); break;
        case Item_func::LE_FUNC: DBUG_CAT("(Item_func_le*)"); break;
        case Item_func::GE_FUNC: DBUG_CAT("(Item_func_ge*)"); break;
        case Item_func::GT_FUNC: DBUG_CAT("(Item_func_gt*)"); break;
        case Item_func::FT_FUNC: DBUG_CAT("(Item_func_match*)"); break;
        case Item_func::ISNOTNULL_FUNC: DBUG_CAT("(Item_func_isnotnull*)"); break;
        case Item_func::COND_AND_FUNC: DBUG_CAT("(Item_cond_and*)"); break;
        case Item_func::COND_OR_FUNC: DBUG_CAT("(Item_cond_or*)"); break;
        case Item_func::XOR_FUNC: DBUG_CAT("(Item_func_xor*)"); break;
        case Item_func::BETWEEN: DBUG_CAT("(Item_func_between*)"); break;
        case Item_func::IN_FUNC: DBUG_CAT("(IN_FUNC*)"); break;
        case Item_func::INTERVAL_FUNC: DBUG_CAT("(INTERVAL_FUNC*)"); break;      // sir does not appear in this film
        case Item_func::ISNOTNULLTEST_FUNC: DBUG_CAT("(Item_is_not_null_test*)"); break;
        case Item_func::SP_EQUALS_FUNC: DBUG_CAT("(mbrequal*)"); break;
        case Item_func::SP_RELATE_FUNC: DBUG_CAT("(SP_RELATE_FUNC*)"); break;
        case Item_func::NOT_FUNC: DBUG_CAT("(Item_func_not*)"); break;
        case Item_func::NOT_ALL_FUNC: DBUG_CAT("(Item_func_not_all*)"); break;
        case Item_func::TEMPTABLE_ROWID: DBUG_CAT("(Item_temptable_rowid*)"); break;
        case Item_func::NOW_FUNC: DBUG_CAT("(Item_func_now_local*)"); break;
        case Item_func::NOW_UTC_FUNC: DBUG_CAT("(Item_func_now_utc*)"); break;
        case Item_func::SYSDATE_FUNC: DBUG_CAT("(Item_func_sysdate_local*)"); break;
        case Item_func::TRIG_COND_FUNC: DBUG_CAT("(Item_func_trig_cond*)"); break;
        case Item_func::SUSERVAR_FUNC: DBUG_CAT("(Item_func_set_user_var*)"); break;
        case Item_func::GUSERVAR_FUNC: DBUG_CAT("(Item_func_get_user_var*)"); break;
        case Item_func::COLLATE_FUNC: DBUG_CAT("(Item_func_set_collation*)"); break;
        case Item_func::EXTRACT_FUNC: DBUG_CAT("(Item_extract*)"); break;
        case Item_func::CHAR_TYPECAST_FUNC: DBUG_CAT("(Item_char_typecast*)"); break;
        case Item_func::FUNC_SP: DBUG_CAT("(Item_func_sp*)"); break;
        case Item_func::UDF_FUNC: DBUG_CAT("(Item_udf_func*)"); break;
        case Item_func::NEG_FUNC: DBUG_CAT("(Item_func_neg*)"); break;
        case Item_func::GSYSVAR_FUNC: DBUG_CAT("(Item_func_get_system_var*)"); break;
        case Item_func::IN_OPTIMIZER_FUNC: DBUG_CAT("(Item_in_optimizer*)"); break;
        case Item_func::DYNCOL_FUNC: DBUG_CAT("(Item_func_dyncol_create*)"); break;
        case Item_func::JSON_EXTRACT_FUNC: DBUG_CAT("(Item_func_json_extract*)"); break;
        case Item_func::CASE_SEARCHED_FUNC: DBUG_CAT("(Item_func_case_searched*)"); break;
        case Item_func::CASE_SIMPLE_FUNC: DBUG_CAT("(Item_func_case_simple*)"); break;
        default:
          DBUG_CAT("(ITEM_FUNC_OTHER*)");
        }
    ...
    case Item::FIELD_AVG_ITEM:
      DBUG_CAT("(Item_avg_field*)");
      dbug_add_print_item_contents(item);
      break;
    case Item::DEFAULT_VALUE_ITEM:
      DBUG_CAT("(Item_default_value*)");
      dbug_add_print_item_contents(item);
      break;
#if MYSQL_VERSION_ID > 100414
    case Item::CONTEXTUALLY_TYPED_VALUE_ITEM:
      DBUG_CAT("(Item_contextually_typed_value_specification*)");
      dbug_add_print_item_contents(item);
      break;
#endif
    case Item::PROC_ITEM:
    ...
    case Item::FIELD_STD_ITEM:
      DBUG_CAT("(Item_std_field*)");
      dbug_add_print_item_contents(item);
      break;
    case Item::FIELD_VARIANCE_ITEM:
      DBUG_CAT("(Item_variance_field*)");
      dbug_add_print_item_contents(item);
      break;
    case Item::INSERT_VALUE_ITEM:
      DBUG_CAT("(Item_insert_value*)");
      dbug_add_print_item_contents(item);
      break;
    case Item::ROW_ITEM:
      DBUG_CAT("(Item_row*)");
    ...
    case Item::TRIGGER_FIELD_ITEM:
      DBUG_CAT("(Item_trigger_field*)");
      dbug_add_print_item_contents(item);
      break;
    case Item::EXPR_CACHE_ITEM:
      DBUG_CAT("(Item_cache_wrapper*)");
      dbug_add_print_item_contents(item);
      break;
    case Item::SUBSELECT_ITEM:
      DBUG_CAT("(Item_subselect*)");
      dbug_add_print_item_contents(item);
      break;
    default:
      DBUG_CAT("(ITEM_UNKNOWN*)");
      dbug_add_print_item_contents(item);
      break;
    }
    DBUG_CAT("]");
