...
#define PART_VERS_ERR_MSG "%s PARTITION (%s)"
    ...
    else
    {
      ...
      case SYSTEM_TIME_AS_OF:
        trx_id0= vers_conditions.start.unit == VERS_TIMESTAMP
          ? newx Item_func_vtq_id(thd, point_in_time1, TR_table::FLD_TRX_ID)
          : point_in_time1;
	...
	cond3= newx Item_func_lt(thd, point_in_time1, point_in_time2);
      case SYSTEM_TIME_BETWEEN:
        trx_id0= vers_conditions.start.unit == VERS_TIMESTAMP
          ? newx Item_func_vtq_id(thd, point_in_time1, TR_table::FLD_TRX_ID, true)
          : point_in_time1;
        trx_id1= vers_conditions.end.unit == VERS_TIMESTAMP
          ? newx Item_func_vtq_id(thd, point_in_time2, TR_table::FLD_TRX_ID, false)
          : point_in_time2;
	...
	if (!cond3)
      ...
      case SYSTEM_TIME_BEFORE:
        trx_id0= vers_conditions.start.unit == VERS_TIMESTAMP
          ? newx Item_func_vtq_id(thd, point_in_time1, TR_table::FLD_TRX_ID, true)
          : point_in_time1;
        cond1= newx Item_func_vtq_trx_sees(thd, trx_id0, row_end);
        break;
      default:
        DBUG_ASSERT(0);
      }
