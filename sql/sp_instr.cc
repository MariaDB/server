...
sp_instr_set_ps_placeholder::exec_core(THD *thd, uint *nextp)
{
  ...
  if (m_deref_rcontext_handler != nullptr)
  {
    /*
      ...
      Evaluate a USING clause expression and store its result into m_value.
    ...
    */
    ...
    /*
      Cache the type handler and the attributes.
    ...
    */
    ...
    const LEX_CSTRING str_cursor_param= {STRING_WITH_LEN("<set cursor_param>")};
